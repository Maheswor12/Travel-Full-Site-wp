...
<?php
    if(have_posts()) {
        while (have_posts()):the_post();
            ...
            $activity_type=get_the_terms( $postid, 'activity_tour' );
                ...
                <div class="card-title__wrapper">
                    ...
                    <div class="card-title__summary_right">
                        <div class="social-icons">
                            <ul class="social-share-links share-link">
            ...
            <div class="offer-block__wrapper">
                <div class="slideshow">
                    <section class="hero-offer js-prevent-cookie" id="gallery">
                        ...
                        <section class="single-tour-social-shares">
                                        ...
                                        <table width="100%" class="table responsive desktop-overview">
                                           ...
                                           <tr>
                                               ...
                                               <td>
                                                   ...
                                                   <span class="desctiption-title"> Fitness level:</span></td>
                                               <td colspan="3">	 <a href="#" class="tooltips"><?php if(!empty($fitness_level)){echo $fitness_level;}else{echo 'N/A';}?><span class="gradeIcon grade2">&nbsp;</span></a>	</td>
                                           </tr>
                                           <tr>
                                               <td>
                                                   <svg class="offer-block__title-icon">
...
<!--                              <a href="#!" rel="external" class="button button-product">-->
...
?>
                    ...
                    if($query2->have_posts()) {
                        ...
                        <section class="related_package">
                            <section class="countdown">
                                <h2 class="countdown__title">Related  Tour</h2>
                            </section>
        ...
        <div class="right_sidebar">
            ...
            <section class="right_sidebar__section right_sidebar__the-nest section__full-width">
                ...
                <ul class="right_sidebar__section-inner">
